// Kolory klubowe GKS Strzegowo (Niebiesko-Białe) i motyw aplikacji
export const COLORS = {
	primary: "#1d4ed8",      // Główny niebieski (Royal Blue)
	...
	error: "#ef4444",        // Czerwony do błędów
	success: "#10b981",      // Zielony do sukcesu
};
